...
<body class="d-flex h-100 text-center text-white bg-dark">
	<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
		...
		<main class="px-3">
			...
			List<Reimbursement> reimbursements = employeeDAO.getAllPending();
			...
			<br />
			<form action="approveReimbursement.jsp" align="left">
				Enter ReimbursementId to approve : <input type="text" name="reimbursementid">
				<input type="submit" value="Enter">
			</form>
			<br/>
			<form action="denyReimbursement.jsp" align="left">
				Enter ReimbursementId to deny : <input type="text" name="reimbursementid">
				<input type="submit" value="Enter">
			</form>
			<br /> <a href="welcomeManager.jsp">Back</a> <br /> <a
